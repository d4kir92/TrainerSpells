...
petAbilityUpdateFrame:SetScript(
    "OnEvent",
    function()
        ...
        for i = 1, numCrafts do
            ...
            if TrainerSkills.learnedPetAbilityMap and TrainerSkills.learnedPetAbilityMap[name] == nil then
                TrainerSkills.learnedPetAbilityMap[name] = {}
            end

            -- some locales may not provide a rank, need more investigation
            if rank ~= nil and TrainerSkills.learnedPetAbilityMap then
                TrainerSkills.learnedPetAbilityMap[name][rank] = true
            end
        end

        TrainerSkills.afterPetUpdate()
    end
)
